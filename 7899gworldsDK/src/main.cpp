...
ez::Drive chassis(
    ...
    10,      // IMU Port
    3.25,  // was 3.25 Wheel Diameter (Remember, 4" wheels without screw holes are actually 4.125!)
...
ez::tracking_wheel horiz_tracker(-15, 2, 1.8);  // This tracking wheel is perpendicular to the drive wheels
