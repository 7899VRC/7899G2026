...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      ...
      {"Left 7 Ball Push", leftseven},
      {"Left 4 Ball Push", leftfour},
      {"Left 4 + 3", leftfourthree},
      {"Right 7 Ball Push", rightseven},
      {"Right 4 Ball Push", rightfour},
      {"Right 4 + 3", rightfourthree},
  });
